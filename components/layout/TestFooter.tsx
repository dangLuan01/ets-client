...
export default function TestFooter({ 
  ...
  return (
    <footer className="shrink-0 z-10 w-full bg-white border-t border-gray-300 shadow-[0_-5px_15px_rgba(0,0,0,0.05)] px-2 md:px-4 py-2 flex items-center justify-between">
