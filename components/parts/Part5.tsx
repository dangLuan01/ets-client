...
export default function Part5({ item }: Part5Props) {
  ...
  return (
    <div key={qId} className="flex flex-col md:flex-row h-full w-full p-2 gap-4 bg-[#f0f2f5] overflow-hidden">
      
      {/* ========== CỘT TRÁI: Hướng dẫn & Giải thích ========== */}
      <div className="w-full md:w-1/2 h-auto md:h-full bg-white border border-gray-300 shadow-sm p-3 lg:p-6 flex flex-col items-stretch overflow-y-auto">
        ...
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
          <div>
            <h2 className="font-bold text-[#1e3a8a] text-lg leading-tight">Incomplete Sentences</h2>
            {isPracticeMode && (
              <p className="text-xs text-gray-500">Chọn từ/cụm từ thích hợp nhất</p>
            )}
          </div>
        </div>
        
        {/* Giải thích - Chỉ hiện khi có đáp án + bật explanation */}
      ...
      <div className="w-full md:w-1/2 h-auto md:h-full bg-white border border-gray-300 shadow-sm p-3 lg:p-6 overflow-y-auto">
